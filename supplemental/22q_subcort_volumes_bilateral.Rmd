...
save_dosage_effect_ws_final$Structure <- "whole volumes"
save_dosage_effect_ws_final$`FDR q` <- NA
save_dosage_effect_all <- rbind(save_dosage_effect_ws_final[,c("Structure","Region","Hemi","beta","p","FDR q")],save_dosage_effect_final[,c("Structure","Region","Hemi","beta","p","FDR q")])
