...
plot age gamms for full sample
```{r}
  #plot chosen gamms
  ...
  #ggsave(plot=plot_age, filename=file.path(project,"figures/age/age_gamms_curves_full.pdf"), width=12, height=7, device = "pdf")
  #ggsave(plot=plot_age, filename=file.path(project,"figures/age/age_gamms_curves_full.png"), width=12, height=7, device = "png", dpi = 300)
```
...
```{r}
  ...
  #ggsave(plot=plot_age_young, filename=file.path(project,"figures/age/age_gamms_curves_u37.pdf"), width=12, height=7, device = "pdf")
  #ggsave(plot=plot_age_young, filename=file.path(project,"figures/age/age_gamms_curves_u37.png"), width=12, height=7, device = "png", dpi = 300)
```
