...
# verbal IQ vs hipp tail in each group
#cvlt_del <- lapply(sc_names_normed, function(r) test_sx_lmm(formula=as.formula(paste("T1_5_T ~ SEX + (1|SUBJECTID) +",r)), data=filter(demo_cvlt, SUBJECT_IDENTITY=="PATIENT-DEL")))
#cvlt_del_p <- lapply(sc_names_normed, function(r) cvlt_del[r,c("Estimate","Pr(>|t|)")]
