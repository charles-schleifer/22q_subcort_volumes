...
lme_combat <- lapply(sc_names_combat, function(r) lmerTest::lmer(formula=reformulate(c("gene_dosage","AGE","SEX","eTIVscaled","site","(1|SUBJECTID)"), response=r),data=demo_combat_na, REML=TRUE))
names(lme_combat) <- sc_names_combat
...
gene_dosage_effect$Region <- sc_names_combat
