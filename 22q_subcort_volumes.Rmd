...
plot_Thal_Whole <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Thal_Whole_thalamus.combat, fill=factor(gene_dosage)),position=position_jitter(w=0.1,h=0,seed=1),shape=21,color="black")+
...
plot_Amy_Whole <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Amy_Whole_amygdala.combat, fill=factor(gene_dosage)),position=position_jitter(w=0.1,h=0,seed=1),shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
...
plot_Hip_Whole <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Hip_Whole_hippocampus.combat, fill=factor(gene_dosage)),position=position_jitter(w=0.1,h=0,seed=1),shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
...
plot_ICV <- ggplot()+
  ...
  geom_point(data=demo_combat_normed,aes(x=gene_dosage,y=eTIV, fill=factor(gene_dosage)), position=position_jitter(w=0.1,h=0,seed=1), shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
...
plot_Thal_MD <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Thal_MD_all.combat,fill=factor(gene_dosage)),position=position_jitter(w=0.1, h=0, seed=1),shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
...
plot_Thal_MV <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Thal_MV_Re_.combat,fill=factor(gene_dosage)),position=position_jitter(w=0.1, h=0, seed=1),shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
...
plot_Hip_tail <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Hip_Hippocampal_tail.combat,fill=factor(gene_dosage)),position=position_jitter(w=0.1, h=0, seed=1),shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
...
plot_Amy_basal <- ggplot()+
  ...
  geom_point(data=demo_combat_na,aes(x=gene_dosage,y=Amy_Basal_nucleus.combat,fill=factor(gene_dosage)),position=position_jitter(w=0.1, h=0, seed=1),shape=21,color="black")+
  scale_x_continuous(limits=c(0.85,3.5), breaks=c(1,2,3), minor_breaks = NULL)+
  scale_fill_viridis(discrete = TRUE, name="", labels=c("22qDel","Control","22qDup"))+
  guides(fill = guide_legend(override.aes = list(size=7)))+
